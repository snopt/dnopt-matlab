...
!     File  iomex.f90
!
!     ioPRNT  ioTRIM  ioREAD
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

subroutine ioPRNT ( mode, string, iw, leniw )
  implicit none
  character*(*) string
  integer       mode, leniw, iw(leniw)

  !=====================================================================
  ! ioPRNT  prints a trimmed form of "string" on various files.
...
subroutine ioREAD ( unitno, string, nchar, endfile )
  implicit none
  character*(*) string
  integer       endfile, nchar, unitno
  !===================================================================
  ! ioREAD reads a string of length nchar from file  unitno.
  !
